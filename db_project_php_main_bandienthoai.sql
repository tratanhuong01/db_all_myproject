...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 31, 2021 lúc 06:52 AM
...
(100, 'SP1000000002', 'KH1000000002', 1),
(101, 'SP1000000025', 'KH1000000002', 7),
(102, 'SP1000000020', 'KH1000000002', 4),
(103, 'SP1000000054', 'KH1000000002', 2),
(104, 'SP1000000052', 'KH1000000002', 1);
...
('KH1000000016', 'Noo', 'Phước Thịnh', 'noophuocthinh@gmail.com', '0924524326', 'Quang Nam', 'Nam', '2001-02-11'),
('KH1000000017', 'Tra', 'Huong', 'tratanhuong011111@gmail.com', '976555555', 'Quang Nam', 'Nam', '2021-01-01');
...
--
-- Cấu trúc bảng cho bảng `motachitiet`
--

CREATE TABLE `motachitiet` (
  `IDMoTa` varchar(12) NOT NULL,
  `IDDongSanPham` varchar(50) DEFAULT NULL,
  `DoPhanGiai` varchar(100) DEFAULT NULL,
  `ManHinhRong` varchar(100) DEFAULT NULL,
  `CameraTruoc` varchar(100) DEFAULT NULL,
  `CameraSau` varchar(100) DEFAULT NULL,
  `RAM` int(11) DEFAULT NULL,
  `TheNho` varchar(100) DEFAULT NULL,
  `MangDiDong` int(11) DEFAULT NULL,
  `WIFI` int(11) DEFAULT NULL,
  `BLUETOOL` int(11) DEFAULT NULL,
  `GPS` int(11) DEFAULT NULL,
  `DungLuongPin` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Đang đổ dữ liệu cho bảng `motachitiet`
--

INSERT INTO `motachitiet` (`IDMoTa`, `IDDongSanPham`, `DoPhanGiai`, `ManHinhRong`, `CameraTruoc`, `CameraSau`, `RAM`, `TheNho`, `MangDiDong`, `WIFI`, `BLUETOOL`, `GPS`, `DungLuongPin`) VALUES
('MOTA1', 'IPHONE11', '828 x 1792 Pixels', '6.1\"', '12MP', '2 Camera@12MP', 4, 'Không', 0, 0, 0, 0, '3110 mAh'),
('MOTA2', 'IPHONE7PLUS', '	Full HD (1080 x 1920 Pixels)', '5.5\"', '7MP', '2 Camera@12MP', 3, 'Không', 0, 0, 0, 0, '2900 mAh');
...
('SP1000000002', 'IPHONE11', 'Iphone 11 64GB Màu Đen', 13990000, 3, 'IPHONE11_', 'DEN', 'Apple', 64, 1),
...
('SP1000000015', 'IPHONE7PLUS', 'Iphone 7 Plus 256GB Màu Đỏ', 8990000, 5, 'IPHONE7PLUS_', 'DO', 'Apple', 256, 3),
...
('SP1000000018', 'IPAD', 'iPad 10.2 2020 32GB 4G Wifi ', 11990000, 4, 'IPAD10_2_20204GWIFI_', 'HONG', 'Apple', 32, 3),
...
('SP1000000022', 'IPHONE11', 'Iphone 11 64GB Màu Đỏ', 14990000, 3, 'IPHONE11_', 'DO', 'Apple', 64, 3),
('SP1000000023', 'IPHONE11', 'Iphone 11 64GB Màu Tím', 14990000, 3, 'IPHONE11_', 'TIM', 'Apple', 64, 0),
('SP1000000024', 'IPHONE11', 'Iphone 11 64GB Màu Trắng', 14990000, 3, 'IPHONE11_', 'TRANG', 'Apple', 64, 1),
...
('SP1000000034', 'LAPTOPASUSVIVOBOOK', 'Laptop Asus VivoBook  i5 1035G1/8GB/512GB/Win10 (EK052T)', 16200000, 3, 'LAPTOPASUSVIVOBOOKX409JA_', 'TRANG', 'Asus', 512, 3),
('SP1000000035', 'LAPTOPASUSSTRIX', 'Laptop Asus Strix G512 IAL001T i7 10750H/8GB/512G SSD/15.6 FHD/WIN10', 16200000, 3, 'LAPTOPASUSSTRIX_', 'DEN', 'Asus', 512, 3),
...
('SP1000000040', 'PINXACDUPHONGSAMSUNG', 'Dell Latitude E7470', 299000, 5, 'PINXACDUPHONGSAMSUNG_', 'BAC', 'Samsung', 10000, 3),
...
('SP1000000042', 'PINXACDUPHONGREMAX', 'Pin Sạc Dự Phòng Remax 5.000mAh (hình thú)', 340000, 5, 'PINXACDUPHONGREMAX_', 'DO', 'Remax', 5000, 3),
...
('SP1000000047', 'APPLEWATCHSE44', 'Apple Watch SE 44mm GPS Nhôm VN/A', 7940000, 5, 'APPLEWATCHSE40_', 'TRANG', 'Apple', 0, 3),
...
('SP1000000051', 'APPLEWATCHSERI6THEP', 'Apple Watch Series 6 Thép 44mm LTE Milanese', 20000000, 5, 'APPLEWATCHSERI6THEP44_', 'TRANG', 'Apple', 0, 3),
('SP1000000052', 'DONGHONAMCITIZEN', 'Đồng hồ Nam Citizen BI5000-87L', 2220000, 5, 'DONGHONAMCITIZEN_', 'BAC', 'Citizen', 0, 3),
...
('SP1000000075', 'XIAOMINOTE8', 'Xiaomi Redmi Note 8 Ram 4GB/64GB Màu Trắng', 3490000, 2, 'XIAOMINOTE8_', 'TRANG', 'Xiaomi', 64, 3),
...
('SP1000000079', 'IPHONE11', 'Iphone 11 256GB Màu Tím', 14990000, 3, 'IPHONE11_', 'TIM', 'Apple', 256, 3),
('SP1000000080', 'IPHONE11', 'Iphone 11 256GB Màu Đen', 14990000, 3, 'IPHONE11_', 'DEN', 'Apple', 256, 0),
('SP1000000081', 'IPHONE11', 'Iphone 11 256GB Màu Trắng', 14990000, 3, 'IPHONE11_', 'TRANG', 'Apple', 256, 0),
('SP1000000082', 'IPHONE11', 'Iphone 11 256GB Màu Vàng', 14990000, 3, 'IPHONE11_', 'VANG', 'Apple', 256, 0),
('SP1000000085', 'IPHONE12MINI', 'Điện thoại iPhone 12 mini 256GB Màu Xanh Lá', 23900000, 3, 'IPHONE12MINI_', 'XANHLA', 'Apple', 256, 3),
('SP1000000086', 'IPHONE12MINI', 'Điện thoại iPhone 12 mini 128GB Màu Xanh Lá', 20900000, 3, 'IPHONE12MINI_', 'XANHLA', 'Apple', 128, 0),
('SP1000000087', 'IPHONE12MINI', 'Điện thoại iPhone 12 mini 64GB Màu Xanh Lá', 23900000, 3, 'IPHONE12MINI_', 'XANHLA', 'Apple', 64, 0);
...
(15, 'KH1000000016', '202cb962ac59075b964b07152d234b70', 1),
(16, 'KH1000000017', '202cb962ac59075b964b07152d234b70', 1);
...
--
-- Chỉ mục cho bảng `motachitiet`
--
ALTER TABLE `motachitiet`
...
--
-- Các ràng buộc cho bảng `motachitiet`
--
ALTER TABLE `motachitiet`
  ADD CONSTRAINT `motachitiet_ibfk_1` FOREIGN KEY (`IDDongSanPham`) REFERENCES `dongsanpham` (`IDDongSanPham`) ON DELETE CASCADE ON UPDATE CASCADE;
